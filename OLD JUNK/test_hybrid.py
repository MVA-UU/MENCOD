"""
Test script for the updated Hybrid Outlier Detection System.

This script verifies that the hybrid model works correctly with the updated 
CitationNetwork implementation using adaptive weighting for consistent results
...
def test_hybrid_model():
    """
    Test the hybrid model with the updated CitationNetwork implementation
    using adaptive weighting for better generalization across datasets.
    """
    print("=== TESTING HYBRID MODEL WITH UPDATED CITATION NETWORK ===")
    print("Using adaptive weighting for better cross-dataset generalization")
    
    # Create the hybrid model with adaptive weighting enabled
